...
def setup_integration():
    ...
    # Remove mocks
    if "FreeCAD" in sys.modules: del sys.modules["FreeCAD"]
    if "FreeCADGui" in sys.modules: del sys.modules["FreeCADGui"]
    if "Part" in sys.modules: del sys.modules["Part"]
...
# Import modules (they will be reloaded by fixture)
from SquatchCut.core import session  # Import session first
from SquatchCut.core import sheet_model
from SquatchCut.gui import nesting_view
